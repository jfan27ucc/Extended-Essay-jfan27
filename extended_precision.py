...
def floattoIEEE754(i):
    ...
    exponent10 = 16383 - base#getting the exponent
    exponent = bin(exponent10)[2:]
    while len(exponent) < 16:
        exponent = '0' + exponent
    #print(exponent)
    ...
    word = sign + '000000000000000' + exponent + fraction#oh yeah, its coming together
    return word
...
def IEEE754tofloat(word):
    ...
    base = int(exponent,2) - 16383#getting the base
    #print(base)

    halfdecs = open('halfdecs.txt','r').read().split()
    decimal = '0'
    for i in range(64):#looping through entire fraction
