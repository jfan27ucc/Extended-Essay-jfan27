...
def floattoIEEE754(i):
    ...
    exponent10 = 1023 - base#getting the exponent
    exponent = bin(exponent10)[2:]
    while len(exponent) < 10:
        exponent = '0' + exponent
    #print(exponent)
...
def IEEE754tofloat(word):
    ...
    base = int(exponent,2) - 1023#getting the base
    #print(base)

    halfdecs = open('halfdecs.txt','r').read().split()
    decimal = '0'
    for i in range(52):#looping through entire fraction
